...
public class Game extends Application{
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        root.getStylesheets().addAll(Objects.requireNonNull(getClass().getResource("StyleGame.css")).toExternalForm());
        ...
        buttonStep.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent event) {
                if (Integer.parseInt(calculator.getPopulation()) > 0) calculator.createPattern();
                else {
                    Alert alert = new Alert(Alert.AlertType.INFORMATION);
                    alert.setTitle("The grid is empty");
                    alert.setHeaderText(null);
        ...
        primaryStage.getIcons().addAll(new Image(Objects.requireNonNull(getClass().getResourceAsStream("/resources/icon.png"))));
        primaryStage.show();         
    }
            ...
            for (int j = 0; j < matrix[i].length; j++) {
                ...
                matrix[i][j].setOnMouseClicked(new EventHandler<MouseEvent>() {
                    ...
                    public void handle(MouseEvent event) {
                        ...
                        int x = calculator.modifyReplic(Integer.parseInt(coords[0]) + 1, Integer.parseInt(coords[1]) + 1);
